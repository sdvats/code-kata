...
if __name__ == '__main__':
    ...
    print("Starting generate fixed width file script......")
    ...
    print(f"\nparsed content written to {delimiter_file_path} file!!!!")
